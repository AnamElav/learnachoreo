        ...
        <div className="w-full max-w-lg mx-auto text-center space-y-8">
          <header>
            ...
            <p className="mt-3 text-zinc-400 leading-relaxed">
              Learn a dance today and get personalized coaching.
            </p>
          </header>
          <div className="rounded-2xl bg-zinc-900/80 border border-zinc-800 p-10 space-y-6">
            <p className="text-sm text-zinc-500">
              Your sessions and coaching notes are tied to your account.
            </p>
            <Link
              href="/auth/login?next=/"
              className="inline-flex h-12 items-center justify-center rounded-xl bg-emerald-600 px-8 text-white font-medium hover:bg-emerald-500 transition"
            >
